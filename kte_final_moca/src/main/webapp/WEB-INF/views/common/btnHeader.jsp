    <!-- 본문 버튼 헤더 시작 -->
        <div class="row" id="btnHeader">
          <div class="col position-relative" >
            <button type="button" id="noticeBtn" data-location="/board/wishList" class="w-100 btn d-block btn-lg mx-auto">
          ...
          <div class="col position-relative">
            <button type="button" id="scheduleBtn" data-location="/schedule/scheduleMain" class="w-100 d-block btn btn-lg mx-auto">
          ...
          <div class="col position-relative">
            <button type="button" id="reservationBtn" data-location="" class="w-100 d-block btn btn-lg mx-auto">
