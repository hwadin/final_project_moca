    <!-- 본문 버튼 헤더 시작 -->
        <div class="row" id="btnHeader">
          <div class="col position-relative" >
            <button type="button" id="noticeBtn" class="w-100 btn d-block btn-lg mx-auto">
          ...
          <div class="col position-relative">
            <button type="button" id="scheduleBtn" class="w-100 d-block btn btn-lg mx-auto">
          ...
          <div class="col position-relative">
            <button type="button" id="inviteBtn" class="w-100 d-block btn btn-lg mx-auto">
          ...
          <div class="col position-relative">
            <button type="button" id="reservationBtn" class="w-100 d-block btn btn-lg mx-auto">
          ...
          <div class="col position-relative">
            <button type="button" id="cafeBtn" class="w-100 d-block btn btn-lg mx-auto">
